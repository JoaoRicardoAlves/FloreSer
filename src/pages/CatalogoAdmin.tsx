...
export default function CatalogoAdmin() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      setIsAdminLogged(!!user && tipo === 'admin');
    };
    init();
  }, []);
  ...
  const handleCreate = async (e: FormEvent) => {
    ...
    if (imagemFile) {
      ...
      imagem_url = `${import.meta.env.VITE_SUPABASE_URL}/storage/v1/object/public/plantas/${fileName}`;
    }
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Nome popular</label>
                <input
              ...
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Nome científico</label>
                <input
                  className="w-full border border-[#D3C4AB] rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E86D47]/60 bg-white"
              ...
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Descrição (opcional)</label>
                <textarea
              ...
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Imagem da planta</label>
                <input
                  type="file"
                  accept="image/*"
              ...
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Características (uma por linha)</label>
                <textarea
              ...
              <div>
                <label className="block text-sm text-[#4A3933] mb-1">Curiosidades (opcional)</label>
                <textarea
                  className="w-full border border-[#D3C4AB] rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E86D47]/60 bg-white min-h-[60px]"
                  value={curiosidades}
